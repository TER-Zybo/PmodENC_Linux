...
wire   [0:0] icmp_ln1326_fu_112_p2;
...
reg   [63:0] bytePlanes_plane1_read_reg_151;
reg    ap_block_pp0_stage0_01001;
reg   [12:0] x_fu_70;
wire   [12:0] add_ln1326_fu_118_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1326_fu_112_p2 == 1'd0))) begin
            x_fu_70 <= add_ln1326_fu_118_p2;
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1326_fu_112_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln1326_fu_118_p2 = (ap_sig_allocacmp_x_6 + 13'd1);
...
assign icmp_ln1326_fu_112_p2 = ((ap_sig_allocacmp_x_6 == div) ? 1'b1 : 1'b0);
...
assign m_axi_mm_video_WDATA = bytePlanes_plane1_read_reg_151;
...
endmodule //system_v_frmbuf_wr_0_0_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1326_2
