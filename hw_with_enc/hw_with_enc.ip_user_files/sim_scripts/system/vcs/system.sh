...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/nfs/home/m1info3/Documents/TER_FPGA/hw_with_enc/hw_with_enc.cache/compile_simlib/vcs"
  fi
