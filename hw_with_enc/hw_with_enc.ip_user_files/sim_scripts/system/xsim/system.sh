...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_14 -L processing_system7_vip_v1_0_16 -L mipi_dphy_v4_3_6 -L xilinx_vip"
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 interrupt_control_v3_1_4 axi_gpio_v2_0_30 xlconstant_v1_1_7)
