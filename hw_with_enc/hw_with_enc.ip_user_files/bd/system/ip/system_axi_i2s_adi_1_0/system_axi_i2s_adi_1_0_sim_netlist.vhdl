...
entity system_axi_i2s_adi_1_0_axi_i2s_adi_S_AXI is
  port (
  ...
  attribute ORIG_REF_NAME of system_axi_i2s_adi_1_0_axi_i2s_adi_S_AXI : entity is "axi_i2s_adi_S_AXI";
end system_axi_i2s_adi_1_0_axi_i2s_adi_S_AXI;

architecture STRUCTURE of system_axi_i2s_adi_1_0_axi_i2s_adi_S_AXI is
  ...
  attribute SOFT_HLUTNM of \I2S_CLK_CONTROL_REG[23]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \I2S_CLK_CONTROL_REG[23]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \I2S_RESET_REG[2]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \PERIOD_LEN_REG[15]_i_1\ : label is "soft_lutpair4";
...
\fifo.free_cnt[2]_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F708EF10"
    )
        port map (
...
entity system_axi_i2s_adi_1_0_dma_fifo_0 is
  port (
    ...
    s00_axi_aclk : in STD_LOGIC;
    \rd_addr_reg[0]_0\ : in STD_LOGIC;
    \fifo.free_cnt_reg[0]_0\ : in STD_LOGIC;
    \fifo.free_cnt_reg[3]_0\ : in STD_LOGIC;
    rx_stb : in STD_LOGIC;
...
architecture STRUCTURE of system_axi_i2s_adi_1_0_dma_fifo_0 is
  ...
  signal \^empty_reg_0\ : STD_LOGIC;
  signal \fifo.free_cnt[0]_i_1_n_0\ : STD_LOGIC;
  signal \fifo.free_cnt[1]_i_1_n_0\ : STD_LOGIC;
  signal \fifo.free_cnt[2]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute ram_slice_end of data_fifo_reg_0_7_6_11 : label is 11;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \fifo.free_cnt[0]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \fifo.free_cnt[1]_i_1\ : label is "soft_lutpair26";
...
empty_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000400000290000"
        ...
        port map (
      I0 => \fifo.free_cnt_reg[3]_0\,
      I1 => \fifo.free_cnt_reg[0]_0\,
...
\fifo.free_cnt[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2DD2"
    )
        port map (
      ...
      O => \fifo.free_cnt[0]_i_1_n_0\
    );
\fifo.free_cnt[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6CC96C6C"
    )
        port map (
...
full_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \fifo.free_cnt_reg_n_0_[0]\,
      I3 => \fifo.free_cnt_reg_n_0_[1]\,
      I4 => \fifo.free_cnt_reg[0]_0\,
      I5 => \fifo.free_cnt_reg[3]_0\,
      O => full_i_1_n_0
    );
full_reg: unisim.vcomponents.FDRE
     port map (
...
architecture STRUCTURE of system_axi_i2s_adi_1_0_i2s_clkgen is
  ...
  attribute SOFT_HLUTNM of bclk_int_i_1 : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \gen[0].data_int[0][13]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \gen[0].data_int[0][14]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \gen[0].data_int[0][15]_i_1\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \gen[0].data_int[0][25]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \gen[0].data_int[0][26]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \gen[0].data_int[0][27]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \gen[0].data_int[0][28]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \gen[0].data_int[0][29]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \gen[0].data_int[0][30]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \gen[0].data_int[0][31]_i_3\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of lrclk_int_i_2 : label is "soft_lutpair7";
begin
...
entity system_axi_i2s_adi_1_0_i2s_tx is
  port (
    ...
    \fifo.free_cnt_reg[0]\ : in STD_LOGIC;
...
architecture STRUCTURE of system_axi_i2s_adi_1_0_i2s_tx is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \fifo.free_cnt[0]_i_1__0\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \fifo.free_cnt[3]_i_2\ : label is "soft_lutpair23";
begin
  bclk_d1 <= \^bclk_d1\;
...
\tx_gen.tx\: entity work.system_axi_i2s_adi_1_0_i2s_tx
     port map (
      ...
      \fifo.free_cnt_reg[0]\ => \fifo.free_cnt_reg[0]\,
...
entity \system_axi_i2s_adi_1_0_pl330_dma_fifo__parameterized0\ is
  port (
    ...
    \rd_addr_reg[0]_0\ : in STD_LOGIC;
    \fifo.free_cnt_reg[0]\ : in STD_LOGIC;
    \fifo.free_cnt_reg[3]\ : in STD_LOGIC;
    rx_stb : in STD_LOGIC;
    rx_fifo_reset : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
...
fifo: entity work.system_axi_i2s_adi_1_0_dma_fifo_0
     port map (
      ...
      \fifo.free_cnt_reg[0]_0\ => \fifo.free_cnt_reg[0]\,
      \fifo.free_cnt_reg[3]_0\ => \fifo.free_cnt_reg[3]\,
      full_reg_0 => full_reg,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_axi_i2s_adi_1_0_axi_i2s_adi_v1_2 is
  port (
    DMA_REQ_TX_DRTYPE : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_axi_i2s_adi_1_0_axi_i2s_adi_v1_2 : entity is "axi_i2s_adi_v1_2";
end system_axi_i2s_adi_1_0_axi_i2s_adi_v1_2;

architecture STRUCTURE of system_axi_i2s_adi_1_0_axi_i2s_adi_v1_2 is
...
axi_i2s_adi_S_AXI_inst: entity work.system_axi_i2s_adi_1_0_axi_i2s_adi_S_AXI
     port map (
...
ctrl: entity work.system_axi_i2s_adi_1_0_i2s_controller
     port map (
      ...
      \fifo.free_cnt_reg[0]\ => axi_i2s_adi_S_AXI_inst_n_7,
...
\pl330_dma_rx_gen.rx_fifo\: entity work.\system_axi_i2s_adi_1_0_pl330_dma_fifo__parameterized0\
     port map (
      ...
      \fifo.free_cnt_reg[0]\ => axi_i2s_adi_S_AXI_inst_n_6,
      \fifo.free_cnt_reg[3]\ => ctrl_n_7,
...
\pl330_dma_tx_gen.tx_fifo\: entity work.system_axi_i2s_adi_1_0_pl330_dma_fifo
     port map (
      ...
      empty => empty,
      enable_int => \tx_gen.tx/enable_int\,
      \fifo.free_cnt_reg[2]\ => axi_i2s_adi_S_AXI_inst_n_7,
      \fifo.free_cnt_reg[2]_0\ => ctrl_n_6,
      full => full,
      out_data(23 downto 0) => out_data(23 downto 0),
      \p_0_in__1\ => \p_0_in__1\,
      s00_axi_aclk => s00_axi_aclk,
...
entity system_axi_i2s_adi_1_0 is
  ...
  attribute CHECK_LICENSE_TYPE of system_axi_i2s_adi_1_0 : entity is "system_axi_i2s_adi_1_0,axi_i2s_adi_v1_2,{}";
...
architecture STRUCTURE of system_axi_i2s_adi_1_0 is
  ...
  attribute x_interface_parameter of DMA_REQ_RX_ACLK : signal is "XIL_INTERFACENAME DMA_RX_CLK, ASSOCIATED_BUSIF DMA_RX_REQ:DMA_RX_ACK, ASSOCIATED_RESET DMA_REQ_RX_RSTN, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of DMA_REQ_RX_DAVALID : signal is "XIL_INTERFACENAME DMA_RX_ACK, TDATA_NUM_BYTES 0, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 2, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of DMA_REQ_RX_DRVALID : signal is "XIL_INTERFACENAME DMA_RX_REQ, TDATA_NUM_BYTES 0, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 2, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of DMA_REQ_TX_ACLK : signal is "XIL_INTERFACENAME DMA_TX_CLK, ASSOCIATED_BUSIF DMA_TX_REQ:DMA_TX_ACK, ASSOCIATED_RESET DMA_REQ_TX_RSTN, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
...
U0: entity work.system_axi_i2s_adi_1_0_axi_i2s_adi_v1_2
     port map (
      BCLK_O(0) => BCLK_O(0),
      DATA_CLK_I => DATA_CLK_I,
      DMA_REQ_RX_ACLK => DMA_REQ_RX_ACLK,
