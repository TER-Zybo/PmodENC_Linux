...
reg   [31:0] frm_buffer2_read_reg_224;
reg   [31:0] frm_buffer_read_reg_229;
reg   [15:0] stride_read_reg_234;
wire   [5:0] empty_fu_194_p1;
reg   [5:0] empty_reg_239;
wire   [11:0] empty_51_fu_198_p1;
reg   [11:0] empty_51_reg_244;
wire   [11:0] empty_52_fu_202_p1;
reg   [11:0] empty_52_reg_249;
wire  signed [14:0] empty_53_fu_206_p1;
reg  signed [14:0] empty_53_reg_254;
reg   [2:0] BYTES_PER_PIXEL_load_reg_269;
wire    ap_CS_fsm_state2;
reg   [2:0] colorFormat_reg_274;
wire   [14:0] WidthInBytes_fu_219_p2;
reg   [14:0] WidthInBytes_reg_279;
...
wire   [31:0] zext_ln194_fu_210_p1;
...
wire   [14:0] WidthInBytes_fu_219_p10;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state4) | ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_166_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state5)))) begin
...
assign BYTES_PER_PIXEL_address0 = zext_ln194_fu_210_p1;

assign MEMORY2LIVE_address0 = zext_ln194_fu_210_p1;

assign WidthInBytes_fu_219_p1 = WidthInBytes_fu_219_p10;

assign WidthInBytes_fu_219_p10 = BYTES_PER_PIXEL_load_reg_269;
...
always @ (*) begin
    ap_block_state5_on_subcall_done = ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_166_ap_ready & ap_sync_grp_FrmbufWrHlsDataFlow_fu_166_ap_done) == 1'b0);
end
...
assign empty_51_fu_198_p1 = height[11:0];

assign empty_52_fu_202_p1 = width[11:0];

assign empty_53_fu_206_p1 = width[14:0];

assign empty_fu_194_p1 = video_format[5:0];
...
assign zext_ln194_fu_210_p1 = video_format;
