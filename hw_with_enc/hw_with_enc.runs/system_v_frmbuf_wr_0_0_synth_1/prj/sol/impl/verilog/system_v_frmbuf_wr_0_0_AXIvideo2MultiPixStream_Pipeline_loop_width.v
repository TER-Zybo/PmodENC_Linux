...
reg    ap_idle_pp0;
wire   [0:0] icmp_ln257_fu_215_p2;
wire   [0:0] or_ln261_fu_227_p2;
reg    ap_predicate_op37_read_state1;
reg    ap_block_state1_pp0_stage0_iter0;
reg   [0:0] icmp_ln257_reg_351;
...
wire   [7:0] select_ln290_2_fu_300_p3;
wire   [7:0] select_ln290_1_fu_293_p3;
wire   [7:0] select_ln290_fu_276_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln257_fu_215_p2 == 1'd0) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln257_fu_215_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln257_fu_215_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln257_reg_351 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln257_reg_351 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        img_write = 1'b1;
    end else begin
        img_write = 1'b0;
    end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln257_reg_351 == 1'd0) & (img_full_n == 1'b0));
end

always @ (*) begin
    ap_condition_266 = ((icmp_ln257_reg_351 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_condition_269 = ((or_ln261_fu_227_p2 == 1'd0) & (icmp_ln257_fu_215_p2 == 1'd0) & (ap_start_int == 1'b1));
end

always @ (*) begin
    ap_condition_274 = ((icmp_ln257_reg_351 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_predicate_op37_read_state1 = ((or_ln261_fu_227_p2 == 1'd0) & (icmp_ln257_fu_215_p2 == 1'd0));
end

assign axi_data_3_out = axi_data_fu_98;

assign eol_out = eol_reg_175;

assign icmp_ln257_fu_215_p2 = ((ap_sig_allocacmp_j_1 == cols) ? 1'b1 : 1'b0);

assign img_din = {{{select_ln290_2_fu_300_p3}, {select_ln290_1_fu_293_p3}}, {select_ln290_fu_276_p3}};

assign j_2_fu_221_p2 = (ap_sig_allocacmp_j_1 + 12'd1);

assign or_ln261_fu_227_p2 = (ap_phi_mux_sof_phi_fu_189_p4 | ap_phi_mux_eol_phi_fu_178_p4);

assign select_ln290_1_fu_293_p3 = ((cond[0:0] == 1'b1) ? trunc_ln63_fu_272_p1 : tmp_1_fu_283_p4);

assign select_ln290_2_fu_300_p3 = ((cond[0:0] == 1'b1) ? tmp_1_fu_283_p4 : tmp_s_fu_262_p4);

assign select_ln290_fu_276_p3 = ((cond[0:0] == 1'b1) ? tmp_s_fu_262_p4 : trunc_ln63_fu_272_p1);
