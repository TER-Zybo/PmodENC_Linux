...
architecture rtl of system_v_frmbuf_wr_0_0_start_for_Bytes2AXIMMvideo_U0 is

    component system_v_frmbuf_wr_0_0_start_for_Bytes2AXIMMvideo_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_system_v_frmbuf_wr_0_0_start_for_Bytes2AXIMMvideo_U0_ShiftReg : system_v_frmbuf_wr_0_0_start_for_Bytes2AXIMMvideo_U0_ShiftReg
    generic map (
...
entity system_v_frmbuf_wr_0_0_start_for_Bytes2AXIMMvideo_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end system_v_frmbuf_wr_0_0_start_for_Bytes2AXIMMvideo_U0_ShiftReg;

architecture rtl of system_v_frmbuf_wr_0_0_start_for_Bytes2AXIMMvideo_U0_ShiftReg is
