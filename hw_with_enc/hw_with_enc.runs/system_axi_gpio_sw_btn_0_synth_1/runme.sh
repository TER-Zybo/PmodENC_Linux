...
HD_PWD='C:/Users/hdway/Documents/vivado/TER/PmodENC_Linux/hw_with_enc/hw_with_enc.runs/system_axi_gpio_sw_btn_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_gpio_sw_btn_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_gpio_sw_btn_0.tcl
